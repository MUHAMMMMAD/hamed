...
> **حدود النسخة الثابتة:** محرّك التسعير كامل ويعمل بلا إنترنت (عدا قراءة Excel
> التي تحتاج اتصالاً لتحميل مكتبة القراءة — وCSV يعمل دائماً). مجلس نماذج الذكاء
> الاصطناعي الحيّ غير متاح (يحتاج خادماً). تعديلات الأسعار تُحفظ في متصفح كل
> مستخدم على حدة. لمشاركة البيانات ومجلس LLM، استخدم نسخة الخادم — الطريقة (د).
