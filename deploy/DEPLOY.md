...
> ### ⚠️ الاستضافة المشتركة (cPanel) لا تشغّل هذا النظام
> هذا تطبيق **Python (FastAPI)** يحتاج خادماً يشغّله — وليس موقع HTML ثابت.
> إن لم تتوفّر "Setup Python App" في cPanel (وهو وضعكم)، اختر أحد المسارات
> التالية وابقِ موقعكم الرئيسي على cPanel كما هو:
>
> | المسار | الكلفة | الجهد | متى تختاره |
> |---|---|---|---|
> | **(د) Render** | مجاني/≈26﷼ شهرياً | الأسهل (نقرات) | بلا إدارة خادم — موصى به للبدء |
> | **(أ) VPS مجاني (Oracle)** | مجاني دائماً | متوسط | تحكّم كامل بلا تكلفة |
> | **(أ) VPS مدفوع (Hetzner)** | ≈20﷼ شهرياً | متوسط | أداء وثبات أعلى |
>
> ثم وجّه النطاق الفرعي `tender.m-t.sa` إلى المنصة عبر DNS (خطوة أدناه).
